...
Pulls saved items from Matter and normalises them into Larkspur bookmarks.
...
BASE_URL = "https://api.getmatter.com/api/v1"
TIMEOUT = 15.0
PAGE_SIZE = 100
...
def sync(token: str) -> list[Bookmark]:
    ...
    for item in client.iter_items():
        try:
            ...
            log.warning("skipping malformed Matter item: %r", item)
    return out
